...
let slideWidth = system.args[3] ? system.args[3].split( 'x' )[0] : 960;
let slideHeight = system.args[3] ? system.args[3].split( 'x' )[1] : 700;
...
let inputFile = system.args[1] || 'index.html?print-pdf';
